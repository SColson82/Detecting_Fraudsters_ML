...
# Assuming xTrainData is your data frame with columns item1 through item24
# You can replace this with your actual data frame name
...
png("bar_chart.png", width = 1200, height = 600)  # Adjust width and height as needed
barplot(frequency_df$Frequency, names.arg = frequency_df$Value,
        col = value_colors, main = "Bar Chart of Unique Values Frequency (Log Scale)",
...
png("legend.png", width = 1300, height = 650)  # Adjust width and height as needed
